          ...
          <div style={{ 
            ...
            {showWelcome && (
              ...
              onClick={(e) => {
                ...
                <div style={{ 
                  fontSize: fs.welcomeIcon,
                  marginBottom: isMobile ? '5px' : '8px',
                  filter: 'drop-shadow(0 0 8px rgba(255,215,0,0.5))'
                }}>👆</div>
                <p style={{
                  color: '#FFD700', fontSize: fs.welcomeText,
                  fontWeight: '700', fontFamily: "'Agency FB', 'Arial Narrow', sans-serif",
                  letterSpacing: '2px', margin: 0, textAlign: 'center',
                  textShadow: '0 0 10px rgba(255,215,0,0.5)',
                  lineHeight: '1.3'
                }}>Tap the Card to<br/>Receive Your Eidi</p>
              </div>
            )}
          </div>
        </div>
